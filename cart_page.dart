...
class CartPage extends StatelessWidget {
  ...
  Future<void> _confirmOrder(
    ...
    await context.read<OrderState>().addFromCart(cart, table);
    final order = context.read<OrderState>().orderOf(table);
if (order != null) {
  await context.read<OrderState>().sendOrderToServer(order);
}

    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('注文を受け付けました')),
      );
